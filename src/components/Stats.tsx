...
//     { value: '4.9/5', label: 'Average Rating', description: 'From 100+ reviews', numValue: 4.9 },
...
//                     ease: 'power2.out',
//                     onUpdate: function() {
//                       el.innerHTML = `$${counter.value.toFixed(0)}K+`;
//                     }
//                   });
//                 } else {
//                   // Number animation
...
//                     ease: 'power2.out',
//                     onUpdate: function() {
//                       el.innerHTML = `${counter.value.toFixed(1)}/5`;
//                     }
//                   });
//                 } else if (index === 3) {
...
//               <div 
//                 ref={(el) => (numbersRef.current[index] = el)}
//                 className={`text-5xl md:text-6xl mb-3 font-bold ${index === 3 ? 'text-orange-300' : ''}`}
//               >
//                 0
//               </div>
