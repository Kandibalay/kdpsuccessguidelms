...
// // Expected API response type (adjust to your backend)
...
//               animate={{ opacity: 1, y: 0 }}
//             >
//               <div className="inline-block bg-orange-500/10 text-orange-600 px-4 py-2 rounded-full border border-orange-200 mb-4">
//                 Welcome Back
//               </div>
//               <h1 className="text-4xl text-gray-900 mb-3">Sign In to Your Account</h1>
//               <p className="text-gray-600">Continue your journey to KDP publishing success</p>
...
//                 <Link to="/enroll" className="text-primary">Create one</Link>
//               </div>
//             </motion.div>
      ...
      <div className="py-20 bg-secondary">
        <div className="container mx-auto px-6">
          <div className="max-w-md mx-auto">
            ...
            <div className="mt-6 text-center text-sm">
              <CheckCircle className="inline text-green-600 mr-1" />
              Secure login with encryption
            </div>
