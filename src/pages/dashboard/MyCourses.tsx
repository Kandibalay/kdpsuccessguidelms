...
// import { getCompletedVideoCount, hasCourseStarted, getAllCoursesWithProgress } from '../../utils/courseProgress';
...
//     const completedCount = progressData[courseId] || 0;
...
//   // Get total completed videos across all courses (synced with Overview)
//   const getTotalCompletedVideos = () => {
//     return Object.values(progressData).reduce((sum, count) => sum + count, 0);
//   };

//   // Get active courses count (courses with progress) - synced with Overview
...
//             const completedCount = progressData[course._id] || 0;
//             const courseStarted = hasCourseStarted(course._id);
