...
//     // Check what's in localStorage/headers before login
//     console.log('🔍 [LOGIN SUBMIT] Before login attempt:', {
//       localStorage: localStorage.getItem('auth'),
//       axiosHeader: axios.defaults.headers.common['Authorization']
//     });
...
//         console.log('⚠️ [LOGIN SUBMIT] Session conflict detected!');
//         console.log('📊 [LOGIN SUBMIT] Active sessions:', response.activeSessions);
...
//         console.log('✅ [LOGIN SUBMIT] Login successful');
...
//     console.log('🔄 [FORCE LOGIN] Retrying with clearOtherSessions flag...');
...
//       console.log('📦 [FORCE LOGIN] Response:', {
//         success: response.success,
//         message: response.message
//       });
...
//     console.log('❌ [LOGIN] User cancelled force login');
//     setShowSessionConflict(false);
//     setPendingLoginData(null);
//   };
...
export function Login() {
  ...
  useEffect(() => {
    ...
    console.log('🧹 [Login] Cleaned up stale auth data');
  }, []);
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      if (response.requiresConfirmation) {
        ...
        console.log('✅ [LOGIN SUBMIT] Login successful, redirecting to:', from);
  ...
  const handleClearAndLogin = async () => {
    ...
    try {
      ...
      if (response.success) {
        console.log('✅ [FORCE LOGIN] Login successful, redirecting to:', from);
        toast.success('Login successful 🎉');
        setPendingLoginData(null);
