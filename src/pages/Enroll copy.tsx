...
//       // The signup function in AuthContext will handle navigation
//     } catch (error) {
...
//                   >
//                     <div className="text-green-600 text-sm flex-1">
//                       {successMessage}
//                     </div>
//                   </motion.div>
//                 )}
...
//                           },
//                         })}
//                         className={`w-full pl-12 pr-4 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
//                           errors.fullName ? 'border-red-500' : 'border-gray-300'
//                         }`}
//                         placeholder="John Doe"
//                       />
...
//                           },
//                         })}
//                         className={`w-full pl-12 pr-12 py-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary transition-all disabled:opacity-50 disabled:cursor-not-allowed ${
//                           errors.password ? 'border-red-500' : 'border-gray-300'
//                         }`}
//                         placeholder="Create a strong password"
//                       />
...
//                           required: 'You must agree to the terms and conditions',
//                         })}
//                         className={`w-4 h-4 mt-0.5 text-primary border-gray-300 rounded focus:ring-primary disabled:opacity-50 disabled:cursor-not-allowed ${
//                           errors.agreeToTerms ? 'border-red-500' : ''
//                         }`}
//                       />
//                       <span className="text-sm text-gray-700">
        ...
        <div className="container mx-auto px-6">
          ...
          <motion.div className="text-center mb-12">
            ...
            <p className="text-gray-600">
              Start your journey to Amazon KDP publishing success
            </p>
          </motion.div>
